...
if (ima[indexTag].length>0){$("#ardoraChecks").css("width","285");
var newDiv = $('<div id="imaForTag" tabindex="0"></div>);');newDiv.css({height:"350px",width:"350px",position:"relative",padding: "0px",margin: "0px",float:"right"});
