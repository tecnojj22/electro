...
if (ima[indexTag].length>0){$("#ardoraChecks").css("width","135");
var newDiv = $('<div id="imaForTag" tabindex="0"></div>);');newDiv.css({height:"500px",width:"500px",position:"relative",padding: "0px",margin: "0px",float:"right"});
